...
using MediatrExtension.Core.Extensions;
...
namespace MediatrExtension.Shared.View
{
    public partial class MediatrMessageSettingsWindow : DialogWindow, INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public MediatrMessageSettingsWindow(StoredUserSettings settings)
        {
            InitializeComponent();
        ...
        public CreateMessage GetCreateMessageModel()
        {
