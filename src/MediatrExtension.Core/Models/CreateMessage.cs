...
namespace MediatrExtension.Core.Models
{
    public class CreateMessage
    {
        ...
        public bool ShouldCreateViewModel => ResponseType == ResponseType.NewItem;
        ...
        public string[] HandlerImports => DefaultHandlerImports.Union(Imports).Distinct().ToArray();
        ...
        public List<TypeNameModel> ConstructorParameters
        {
            get
            {
        ...
        public string RequestHandlerIndent => OneClassStyle ? "\t\t\t\t" : "\t\t\t";
    }
}
